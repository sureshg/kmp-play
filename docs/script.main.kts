...
@file:DependsOn("io.ktor:ktor-client-core:3.5.1")
@file:DependsOn("io.ktor:ktor-client-cio:3.5.1")
@file:DependsOn("io.ktor:ktor-client-java:3.5.1")
@file:DependsOn("io.ktor:ktor-client-auth:3.5.1")
...
@file:DependsOn("com.microsoft.playwright:playwright:1.61.0")
